...
public class BubblesRecursion {
    ...
    public static void main (String[] args) {
        ...
        // при повторном запуске сортировка отсортированного массива происходит
        // мнговенно
    ...
    private static void sort (int[] array) {
        ...
        // существенно снижает время, если архив почти отсортирован и время
        // равно 0, если полностью
        if (check) {
            sort(array);
        }
    }
