...
public class MySliderUI extends BasicSliderUI {
    public static final ImageIcon BG_LEFT_ICON = new ImageIcon(MySliderUI.class.getResource("icons/bg_left.png"));
    public static final ImageIcon BG_MID_ICON = new ImageIcon(MySliderUI.class.getResource("icons/bg_mid.png"));
    public static final ImageIcon BG_RIGHT_ICON = new ImageIcon(MySliderUI.class.getResource("icons/bg_right.png"));
    public static final ImageIcon BG_FILL_ICON = new ImageIcon(MySliderUI.class.getResource("icons/bg_fill.png"));
    ...
    public static final ImageIcon GRIPPER_ICON = new ImageIcon(MySliderUI.class.getResource("icons/gripper.png"));
    public static final ImageIcon GRIPPER_PRESSED_ICON = new ImageIcon(
            MySliderUI.class.getResource("icons/gripper_pressed.png"));
    ...
    public void paintThumb (Graphics g) {
        ...
        g.drawImage(isDragging() ? GRIPPER_PRESSED_ICON.getImage() : GRIPPER_ICON.getImage(),
                positionX - GRIPPER_ICON.getIconWidth() / 2, positionY - GRIPPER_ICON.getIconHeight() / 2, null);
    }
    ...
    public void paintTrack (Graphics g) {
        if (slider.getOrientation() == JSlider.HORIZONTAL) {
            ...
            g.drawImage(BG_RIGHT_ICON.getImage(), trackRect.x + trackRect.width - BG_RIGHT_ICON.getIconWidth(),
            ...
            g.drawImage(VER_BG_LEFT_ICON.getImage(),
                    trackRect.x + trackRect.width / 2 - VER_BG_LEFT_ICON.getIconWidth() / 2, trackRect.y, null);
            g.drawImage(VER_BG_MID_ICON.getImage(),
                    trackRect.x + trackRect.width / 2 - VER_BG_LEFT_ICON.getIconWidth() / 2,
                    trackRect.y + VER_BG_LEFT_ICON.getIconHeight(), VER_BG_MID_ICON.getIconWidth(),
                    trackRect.height - VER_BG_LEFT_ICON.getIconHeight() - VER_BG_RIGHT_ICON.getIconHeight(), null);
            ...
            g.drawImage(VER_BG_FILL_ICON.getImage(),
                    trackRect.x + trackRect.width / 2 - VER_BG_LEFT_ICON.getIconWidth() / 2 + 1, trackRect.y + 1,
                    VER_BG_FILL_ICON.getIconWidth(),
                    thumbRect.y + thumbRect.height / 2 - trackRect.y - VER_BG_LEFT_ICON.getIconHeight(), null);
        }
    }
