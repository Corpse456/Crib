...
/**
 * 
 * Пример использования регулярных выражений для проверки корректности вводимого
 * имени. Использоование регулярных выражений для этого позволяет существенно
