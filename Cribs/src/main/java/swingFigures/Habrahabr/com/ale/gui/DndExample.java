...
public class DndExample {
    ...
    public static void main (String[] args) {
        ...
        draggablePanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(Color.GRAY),
        ...
        draggablePanel.add(new JLabel("Drag me somewhere!", JLabel.CENTER) {
            {
                setTransferHandler(new TransferHandler() {
                    ...
                    public boolean canImport (TransferSupport support) {
                        ...
                        // Позволяет располагать панель даже когда курсор не над
                        // dragContainer'ом
                ...
                addMouseListener(new MouseAdapter() {
                    public void mousePressed (MouseEvent e) {
                        if (SwingUtilities.isLeftMouseButton(e)) {
                            ...
                            dragged = new BufferedImage(draggablePanel.getWidth(), draggablePanel.getHeight(),
        ...
        DragSourceAdapter dsa = new DragSourceAdapter() {
            ...
            private void updateGlassPane (DragSourceDragEvent dsde) {
                if (f != null && f.isVisible()) {
                    ...
                    glassPane.setPoint(
                            new Point(dsde.getLocation().x - dragContainer.getLocationOnScreen().x - phase.width,
                                    dsde.getLocation().y - dragContainer.getLocationOnScreen().y - phase.height));
                }
            }
