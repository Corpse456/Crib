...
public class AllExamples {
    ...
    private static JPanel createExamplePanel (final int exampleIcon, String exampleName, final Runnable exampleRun) {
        final JPanel panel = new JPanel() {
            ...
            public void paint (Graphics g) {
                ...
                g2d.setPaint(new GradientPaint(0, 0, rollover == exampleIcon ? dark : light, getWidth(), getHeight(),
                        Color.WHITE));
        ...
        panel.add(new JLabel(new ImageIcon(AllExamples.class.getResource("icons/all/" + exampleIcon + ".png"))),
                BorderLayout.CENTER);
